...
interface ShareableImagesProps {
  isOpen: boolean;
  onClose: () => void;
...
const ShareableImages: React.FC<ShareableImagesProps> = ({
  isOpen,
  onClose,
  milestones,
  dateOfBirth
    ...
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-auto">
        <div className="sticky top-0 bg-white border-b border-gray-200 p-4 flex justify-between items-center z-10">
          <h2 className="text-2xl font-bold text-gray-900">Share Your TimeLoom Journey</h2>
          <button
            onClick={onClose}
        ...
        <div className="border-b border-gray-200">
          <nav className="flex -mb-px">
            <button
              ...
              className={`w-1/2 py-3 px-4 text-center font-medium text-lg border-b-2 ${
            ...
            {activeTab === 'milestones' ? (
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  {/* User Age and Badge */}
                  <div className="flex justify-between items-center bg-indigo-600 bg-opacity-10 rounded-lg p-3">
                    <div>
                      <p className="text-sm text-indigo-700">Current Age</p>
                      <p className="text-xl font-bold text-indigo-800">{userAge} years</p>
                    </div>
            ...
            {isGenerating ? (
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                <button
                  ...
                  className="flex flex-col items-center justify-center gap-2 p-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors"
                >
                  <Download size={24} />
                ...
                <button
                  ...
                  className="flex flex-col items-center justify-center gap-2 p-3 bg-gradient-to-br from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-lg transition-colors"
                >
                  <Instagram size={24} />
                ...
                <button
                  ...
                  className="flex flex-col items-center justify-center gap-2 p-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors"
                >
                  <Facebook size={24} />
                ...
                <button
                  ...
                  className="flex flex-col items-center justify-center gap-2 p-3 bg-blue-400 hover:bg-blue-500 text-white rounded-lg transition-colors"
                >
                  <Twitter size={24} />
                ...
                <button
                  ...
                  className="flex flex-col items-center justify-center gap-2 p-3 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors"
                >
...
export default ShareableImages;