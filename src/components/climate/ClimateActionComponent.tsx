...
import { ClimateActionRecommendation, ClimateQuizResults } from '../constants/types';
import { getPersonalizedRecommendations } from '../constants/climateData';
                      ...
                      {recommendation.actions.map((action, idx) => (
                        <li key={idx} className="flex items-center">
                          <button
                            ...
                            className={`h-5 w-5 rounded-full flex-shrink-0 flex items-center justify-center mr-3 border ${completedActions.includes(action.text)
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center mt-1">
                              <span className={`text-xs font-medium px-2 py-0.5 rounded-full ${action.impact === 'High'
